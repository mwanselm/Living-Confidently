<?php
function whole_life_func($atts, $content = ""){
      $html = '<style>
...
<section class="lp-hero hero wl-hero">
  <div class="left">
    <p class="headline">Whole&bull;istic Thinking </p>

    <h1 class="subhead">Whole life insurance is one of the key ingredients to living confidently.</h1>
  </div>
</section>
<section class="world-chaos whole-life-circle-ani std-padding" id="whole-life-circles">
  ...
  <div class="center desktop">
    ...
    <p id="gif-caption-1" class="gif-caption show">of the most financially confident Americans own whole life insurance, according to the Guardian Study of Financial and Emotional Confidence<sup>&trade;</sup></p>
  ...
  <div class="wl-mobile-slider mobile" id="chaos-mobile">
    <div id="chaos-1">
      <figure>
        ...
        <figcaption><span>of the most financially confident Americans own whole life insurance, according to the Guardian Study of Financial and Emotional Confidence<sup>&trade;</sup></span></figcaption>
      </figure>
    </div>
    <div id="chaos-2">
      <figure>
...
<section class="box-container box-container--green">
  <div class="resources-box resources-box--green float-boxes" id="">
    <h3>Resources</h3>
    <ul>
      <li><a href="https://www.livingconfidently.com/whole_life_resources/video-managing-for-the-long-term/" class="analytics icon-video" data-analytics="2">Managing for the Long Term</a></li>
      <li><a href="https://www.livingconfidently.com/whole_life_resources/video-the-why-what-and-how-of-life-insurance/" class="analytics icon-video" data-analytics="7">The Why, What and How of Life Insurance</a></li>
      <li class="desktop"><a href="https://www.livingconfidently.com/whole_life_resources/3-lives-3-paths-1-reality/" class="icon-infographic" data-analytics="13">4 Lives, 3 Paths, 1 Reality</a></li>
      <li class="desktop"><a href="https://www.livingconfidently.com/whole_life_resources/a-whole-new-slice-of-the-pie/" class="analytics icon-infographic" data-analytics="6">A Whole New Slice of the Pie</a></li>
      <li class="desktop"><a href="https://www.livingconfidently.com/whole_life_resources/video-understanding-dividends" class="analytics icon-video" data-analytics="6">Understanding Dividends</a></li>
    </ul>
    <ul class="mobile">
      <li class="mobile"><a href="https://www.livingconfidently.com/whole_life_resources/3-lives-3-paths-1-reality/" class="analytics icon-infographic" data-analytics="13">4 Lives, 3 Paths, 1 Reality</a></li>
            <li class="mobile"><a href="https://www.livingconfidently.com/whole_life_resources/a-whole-new-slice-of-the-pie/" class="analytics icon-infographic" data-analytics="6">A Whole New Slice of the Pie</a></li>
            <li class="mobile"><a href="https://www.livingconfidently.com/whole_life_resources/video-understanding-dividends" class="analytics icon-video" data-analytics="6">Understanding Dividends</a></li>
    </ul>
  </div>
</section>

<section class="copy-blurb width-655">
  <h2 class="section-header">The Whole Truth: <span class="mobile"></span>Benefits of Whole Life</h2>
  <p class="blurb-copy">
...
<section class="carousel light-blue halfsies">
  ...
  <div class="landing-page" id="benefits-desktop">
    ...
    <div class="c-right">
      <h3>Benefits</h3>
      <ul>
        <li>Guaranteed death benefit protection for life – ensuring a legacy<sup><a href="#source-panel" rel="modal:open">[1]</a></sup></li>
        <li>Guaranteed <a href="#cash-value" rel="modal:open">cash value</a> that can be applied toward things such as a new home, education, retirement, charitable giving, or funding a business<sup><a href="#source-panel" rel="modal:open">[2]</a></sup></li>
        <li>Guaranteed premiums once the policy is in force</li>
        <li>Potential dividend payments and additional growth<sup><a href="#source-panel" rel="modal:open">[3]</a></sup></li>
        <li>Built-in tax advantages on both the cash value and death benefit<sup><a href="#source-panel" rel="modal:open">[4]</a></sup></li>
        <li>Protection from disability or illness through optional riders<sup><a href="#source-panel" rel="modal:open">[5]</a></sup></li>
        <li>Protection from creditors, depending on your state<sup><a href="#source-panel" rel="modal:open">[6]</a></sup></li>
      </ul>
    </div>
  </div>
</section>
    ...
    <div>
      <div class="c-left">
        <div class="c-content">
          ...
          <p><strong>Fact:</strong> Many people use the living benefits of whole life as a source for cash, significant purchases or other needs.</p>
        </div>
      </div>
      <div class="c-right">
...
<section class="priorities-mobile vertical-slider myth-slider mobile">
  <div class="priorities-slider myth-slider-wrapper" id="myth-slider-mobile">
    <div class="slide" id="priority-1">
      <div class="copy-block center">
        ...
        <p class="start-faded"><strong>Fact:</strong> Whole life premiums are guaranteed to never increase once the policy is purchased.  There are various policy designs that can avoid “forever” premium payments.</p>
      </div>
      <img src="/wp-content/themes/lc_phase_2/img/c2c/wl_myth1.jpg">
    </div>
...
<section class="copy-blurb rise-above width-725">
  ...
  <p class="blurb-copy">It can help you manage risk by working alongside your traditional mix of fixed assets (like bonds) and equity assets (like stocks). What’s more, it’s immune to market fluctuations, so it’s there when you need it, now or in retirement.</p>
  <div class="push-half">
    <img src="/wp-content/themes/lc_phase_2/img/c2c/whole_life_venn.png" >
  </div>
</section>
<section class="copy-blurb pushdown blue-bg width-965">
  <h2 class="std-header">How much protection is right for me?</h2>
  <p class="wl-std-para">
    While term insurance can protect you in the short term, the right amount of whole life protection you may want depends on where you are in your own life, who depends on you, and your earning power. In general, the younger you are, the more years of your income you need to take into account when deciding on the right policy protection for you. <span class="desktop inline">Hover below to find out.</span>
  </p>
...
<section class="hero family-reading wl-hero">
  <div class="left dark-text desktop">
    ...
    <p>There’s so much more to whole life than you may already know. Check out our resources page and find out more about how it can help you live with greater financial and emotional confidence.</p>
    <p>
      <a href="https://www.livingconfidently.com/whole-life-resources/" class="btn btn-dark-blue">View Resources</a>
    </p>
  </div>
</section>
...
<a href="#watch-new" class="cover-link" rel="modal:open"></a>
...
<section class="panel-sources">
  <h2><a href="#source-panel" rel="modal:open">Sources &amp; Important Disclosures</a></h2>
</section>
<div id="cash-value" style="display: none;">
  <script src="https://fast.wistia.com/embed/medias/bkbkjefnhz.jsonp" async></script><script src="https://fast.wistia.com/assets/external/E-v1.js" async></script><div class="wistia_responsive_padding" style="padding:56.25% 0 0 0;position:relative;"><div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;"><div class="wistia_embed wistia_async_bkbkjefnhz videoFoam=true" style="height:100%;width:100%">&nbsp;</div></div></div>
</div>
<div id="watch-new" style="display: none;">
...
<div id="source-panel" style="display: none;">
  ...
  <p>The Guardian Study of Financial and Emotional Confidence</p>
...
// Priorities Desktop Slider scroll animations
    ...
    var waypoint = new Waypoint({
      element: document.getElementById("myth-slider-mobile"),
      handler: function(direction) {
        $("#priority-1 .copy-block p:first-of-type").addClass("animated fadeInUp");
        setTimeout(function(){
          $("#priority-1 .copy-block p:last-of-type").addClass("animated fadeInUp");
        }, 1100);
        $(".myth-slider-wrapper").slick("slickPlay");
        // $(".myth-slider-wrapper")[0].slick.refresh();
  ...
  var waypoint = new Waypoint({
    element: document.getElementById("chaos-mobile"),
    handler: function(direction) {
      $(".wl-mobile-slider").slick("slickPlay");
    },
    offset: "50%"
  })  
});
...
add_shortcode('whole_life', 'whole_life_func');
?>