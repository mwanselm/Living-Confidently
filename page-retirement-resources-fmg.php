<?php
/*
*  Template Name: Retirement Resources - FMG
*/
 get_header(); ?>

  <script>
    var retirement_res = true;
    var filter;
    <?php
...
<section class="hero wl-resources-hero retirement-resources-hero">
    <div class="home-hero-content">
        <div class="left">
            <p class="headline">YOUR RETIREMENT REALITY</p>

            <h1 class="subhead">Use these helpful resources to plan for a confident second-half.</h1>
        </div>
    </div>
        ...
        <div class="filter-container">
            <div class="filter-left wl-filter">
                ...
                <select class="filters">
                    ...
                    <option <?php if($filter=='Guides'){echo 'selected';} ?> value="Guides" data-taxonomy-terms="guides" data-text='<span class="bold">Guides</span>'>
                        <span class="mobile">Guides</span>
                    </option>
            ...
            <div class="filter-right wl-filter">
                <a href="<?= !empty($_SESSION['prev_page']) ? $_SESSION['prev_page'] : home_url('/my-retirement-reality-fmg'); ?>" target="_self">
