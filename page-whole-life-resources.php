<?php
/*
*  Template Name: Whole Life Resources
*/
 get_header(); ?>

<script>
    var whole_life_res = true, filter;
    <?php if (isset($_GET["filter"])) : $filter = $_GET["filter"]; ?>
        filter = "<?= $filter ?>";
    <?php else : $filter = 'All'; endif; ?>
</script>
        ...
        <div class="filter-container">
            <div class="filter-left wl-filter">
                ...
                <select class="filters">
                    ...
                    <option <?php if ($filter=='Articles') { echo 'selected'; } ?> value="Articles" data-taxonomy-terms="articles" data-text='<span class="bold">Articles</span>'>
                        <span class="mobile">Articles</span>
                    </option>
            ...
            <div class="filter-right wl-filter">
                <a href="javascript:void(0);" onclick="window.history.back();" id="wholeistic_back">
