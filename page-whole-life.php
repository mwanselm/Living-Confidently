<?php
/*
*  Template Name: Whole Life Landing
*/
?>
...
<section class="box-container box-container--green">
	<div class="resources-box resources-box--green float-boxes" id="">
		<h3>Resources</h3>
		<ul>
			<li><a href="/whole_life_resources/video-the-importance-of-mutuality/" class="analytics icon-video" data-analytics="2">The Importance of Mutuality</a></li>
			<li><a href="/whole_life_resources/video-what-is-life-insurance-part-1/" class="analytics icon-video" data-analytics="7">What is Life Insurance? Part 1</a></li>
			<li ><a href="/whole_life_resources/video-what-type-part-2/" class="analytics icon-video" data-analytics="6">What Type? Part 2</a></li>
			<li ><a href="/whole_life_resources/video-how-much-part-3/" class="analytics icon-video" data-analytics="6">How Much? Part 3</a></li>
			<li ><a href="/whole_life_resources/an-important-piece-whole-financial-perspective/" class="analytics icon-infographic" data-analytics="6">An Important Piece of Your Whole Financial Perspective</a></li>
		</ul>
		<!-- <ul class="mobile">
	...
	<div class="landing-page" id="benefits-desktop">
		...
		<div class="c-right">
			...
			<ul>
				...
				<li>Guaranteed <a href="#cash-value" rel="modal:open" class="cash_value">cash value</a> that can be applied toward things such as a new home, education, retirement, charitable giving, or funding a business<sup><a href="#source-panel" rel="modal:open">[2]</a></sup></li>
	...
	<div class="wl-right">
		<div class="table">
			<div class="wrapper">
				...
				<a href="/whole-perspective" class="btn btn-dark-blue" id="learnmore_liam">LEARN MORE</a>
			</div>
		</div>
	</div>
	<div class="clear"></div>
